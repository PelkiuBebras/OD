from od.layers.common import RepVGGBlock, RepBlock, ConvBNReLU, BiFusion
...
class RepBiFPANNeck:
    ...
    def forward(self, input):
        ...
        p_concat_layer1 = down_feat1.cat(fpn_out1, dim=1)
        pan_out1 = self.Rep_n3(p_concat_layer1)

        down_feat0 = self.downsample1(pan_out1)
        p_concat_layer2 = down_feat0.cat(fpn_out0, dim=1)
